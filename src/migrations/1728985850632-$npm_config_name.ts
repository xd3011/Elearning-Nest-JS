...
export class  $npmConfigName1728985850632 implements MigrationInterface {
    name = ' $npmConfigName1728985850632'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_state_enum" AS ENUM('0', '1', '2', '3', '4', '5')`);
        ...
        await queryRunner.query(`CREATE TABLE "token" ("id" SERIAL NOT NULL, "refreshTokens" text array NOT NULL, "otp" character varying NOT NULL, "expiredOtp" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userIdId" integer, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "token" ADD CONSTRAINT "FK_71575e0a22c3ea77742c8453a4c" FOREIGN KEY ("userIdId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "token" DROP CONSTRAINT "FK_71575e0a22c3ea77742c8453a4c"`);
